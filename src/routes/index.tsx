      ...
      <header className="sticky top-0 z-40 border-b border-border bg-background/80 backdrop-blur">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
          ...
          <nav className="flex items-center gap-2 text-sm">
            ...
            <Link to="/register" className="rounded-md bg-primary px-3 py-2 text-primary-foreground hover:bg-primary/90">
              Join a shop
            </Link>
          </nav>
        </div>
        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
          <div>
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <Link to="/create-shop" className="inline-flex items-center gap-2 rounded-lg bg-primary px-5 py-3 text-sm font-medium text-primary-foreground hover:bg-primary/90">
